                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                                <img src="../assets/img/avatars/<?php echo $currentUser->userProfile; ?>" alt="user avatar" class="d-block rounded fit-cover" height="100" width="100" id="uploadedAvatar">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 order-md-0 order-1">
                                                    <form id="formResetPassword" method="post" action="../data/user/owner-resetPassword">
                                                        <div class="row g-3">
                                                            <div class="col-12">
                                                                ยืนยันรหัสผ่านปัจจุบัน <span class="text-danger">*</span>
