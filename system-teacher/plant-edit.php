                                            ...
                                            <form id="formAddImg" method="POST" action="../data/plant/addPlantImg">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <input name="plantImg[]" class="form-control" type="file" multiple>
                                            ...
                                            <div class="row g-2">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="col-6 col-md-3 col-lg-2">
                                                        <a href="../assets/img/plantImgs/<?php echo $img['imgPath']; ?>" target="_blank" class="clickable">
                                                            <img src="../assets/img/plantImgs/<?php echo $img['imgPath']; ?>" class="w-100 h-100 fit-contain rounded-3 border" style="max-height:260px;">
                                                        </a>
                                                    </div>
